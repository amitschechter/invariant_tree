...
import subgroup_robustness_grows_on_trees.src.datasets.tabular
import subgroup_robustness_grows_on_trees.src.datasets.utils
import subgroup_robustness_grows_on_trees.src.torchutils
...
from src.inv_tree_model import RegretMinimizationTree
...
def main(dataset: str,
    ...
    model = RegretMinimizationTree()

    d = dset.d
    privileged_groups, unprivileged_groups = dset.get_privileged_and_unprivileged_groups()
