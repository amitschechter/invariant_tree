...
class Node:
    ...
    def get_max_regret(self, all_env_ginis, left_pos, right_pos, left_totals, right_totals,
        ...
        return np.max(regrets), np.mean(regrets)
    ...
    def get_feature_opt(self, x_arr, y_arr, w_arr):
        ...
        max_regret, avg_regret = self.get_max_regret(all_env_ginis, left_pos, right_pos, left_totals, right_totals,
                                         n_thresholds, n_envs)
        ...
        loss = opt_total_gini + self.lambda_val * avg_regret #* max_regret
